...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('posts_blogimage', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlogImage.order'
        db.delete_column('posts_blogimage', 'order')

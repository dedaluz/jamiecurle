...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stats_querystringparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Visit'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('stats', ['QuerystringParameter'])


    def backwards(self, orm):
        
        # Deleting model 'QuerystringParameter'
        db.delete_table('stats_querystringparameter')

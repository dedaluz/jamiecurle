...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_post', 'content', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    models = {
        ...
        'blog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'related': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Post']", 'null': 'True', 'blank': 'True'}),

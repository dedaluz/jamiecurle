...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'html', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/Users/jcurle/Sites/jamiecurle/templates/blog/html', null=True, recursive=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.html'
        db.delete_column('blog_post', 'html')

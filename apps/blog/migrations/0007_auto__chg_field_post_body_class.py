...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.body_class'
        db.alter_column('blog_post', 'body_class', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Post.body_class'
        db.alter_column('blog_post', 'body_class', self.gf('django.db.models.fields.SlugField')(max_length=50))

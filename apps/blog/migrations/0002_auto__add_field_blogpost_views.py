...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogPost.views'
        db.add_column('blog_blogpost', 'views', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlogPost.views'
        db.delete_column('blog_blogpost', 'views')

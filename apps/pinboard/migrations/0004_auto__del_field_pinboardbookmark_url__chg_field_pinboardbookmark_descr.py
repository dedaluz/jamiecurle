...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pinboard_pinboardbookmark', 'description', self.gf('django.db.models.fields.TextField')(default='asd'))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PinboardBookmark.url'
        raise RuntimeError("Cannot reverse this migration. 'PinboardBookmark.url' and its values cannot be restored.")

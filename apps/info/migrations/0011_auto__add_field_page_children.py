...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.children'
        db.add_column('info_page', 'children', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['info.Page'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.children'
        db.delete_column('info_page', 'children_id')
    ...
    models = {
        ...
        'info.page': {
            ...
            'children': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['info.Page']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstagramPhoto.caption'
        db.alter_column('instagram_instagramphoto', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InstagramPhoto.caption'
        raise RuntimeError("Cannot reverse this migration. 'InstagramPhoto.caption' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramPhoto.img'
        db.add_column('instagram_instagramphoto', 'img', self.gf('django.db.models.fields.files.ImageField')(default='/meh.jpg', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InstagramPhoto.img'
        db.delete_column('instagram_instagramphoto', 'img')

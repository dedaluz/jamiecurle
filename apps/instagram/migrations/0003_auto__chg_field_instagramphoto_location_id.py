...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstagramPhoto.location_id'
        db.alter_column('instagram_instagramphoto', 'location_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InstagramPhoto.location_id'
        raise RuntimeError("Cannot reverse this migration. 'InstagramPhoto.location_id' and its values cannot be restored.")

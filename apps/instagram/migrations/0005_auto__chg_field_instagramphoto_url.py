...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstagramPhoto.url'
        db.alter_column('instagram_instagramphoto', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InstagramPhoto.url'
        raise RuntimeError("Cannot reverse this migration. 'InstagramPhoto.url' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramComment.instagram_id'
        db.add_column('instagram_instagramcomment', 'instagram_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstagramComment.instagram_id'
        db.delete_column('instagram_instagramcomment', 'instagram_id')
